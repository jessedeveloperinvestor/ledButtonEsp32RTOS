...
#define PORTA_1 (GPIO_NUM_25)   // PORTA_1
...
{
    uint8_t porta1 = gpio_get_level(PORTA_1);
...
/////////////////////////////////////////////////////////////////////////////
    ...
    gpio_config_t io_conf2;                     // Ponteiro de configuração dos pinos
    io_conf2.intr_type = GPIO_PIN_INTR_DISABLE; // Desabilita Interrupçoes
    io_conf2.mode = GPIO_MODE_INPUT;            // set as output mode
    io_conf2.pin_bit_mask = (1ULL << PORTA_1);
    io_conf2.pull_down_en = 0; // Desabilita modo PULL-DOWN
    io_conf2.pull_up_en = 0;
    gpio_config(&io_conf2); // Desabilita modo PULL-UP
    /////////////////////////////////////////////////////////////////////////
    //GPIO
